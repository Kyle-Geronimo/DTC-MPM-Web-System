...
<head>
    ...
    <link rel="stylesheet" href="../css/ui-components.css?v=1">
</head>
<body>
    ...
    <script src="../js/ui-components.js?v=1" defer></script>
    <script>
    document.addEventListener('DOMContentLoaded', function () {
        if (!window.UIC) return;
        UIC.FormValidator.attach('#registerForm', {
            firstname:        ['required', {minLength: 2}],
            lastname:         ['required', {minLength: 2}],
            email:            ['required', 'email'],
            password:         ['required', {minLength: 8}],
            confirm_password: ['required', {match: '#registerForm [name="password"]'}]
        });
    });
    </script>
</body>
