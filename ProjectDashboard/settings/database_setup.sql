...
-- Insert Sample Users
INSERT INTO users (username, email, password, full_name, phone, department, role, status) VALUES
...
INSERT INTO projects (name, description, status, start_date, end_date, progress, created_by) VALUES
...
INSERT INTO system_monitoring (metric_name, metric_value, unit, threshold_warning, threshold_critical, status) VALUES
...
INSERT INTO alerts (alert_type, subject, message, severity, status) VALUES
('system', 'High Memory Usage', 'Memory usage is at 75%. Consider optimizing or scaling up.', 'warning', 'active'),
('info', 'Backup Completed', 'Database backup completed successfully.', 'info', 'resolved'),
('success', 'System Update', 'Security patches have been successfully applied.', 'success', 'resolved');
