...
try {
    switch ($section) {
        ...
        case 'activity':
            ...
            break;
        case 'reports':
            $response['data'] = getRecentReports($conn, 10);
            break;
        case 'notifications':
        ...
        default:
            ...
            $response['data'] = [
                ...
                'reports' => getRecentReports($conn, 10),
...
function getRecentReports($conn, $limit = 10) {
    ...
    while ($r = $res->fetch_assoc()) {
        ...
        $r['content_parsed'] = $decoded !== null ? $decoded : $r['content'];
        $out[] = $r;
    }
    $stmt->close();
    return $out;
...
// timeAgo() function moved to helpers.php
?>
