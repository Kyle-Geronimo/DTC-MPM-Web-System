...
// Defensive check: ensure $conn is available
if (!isset($conn) || !($conn instanceof mysqli)) {
    echo "<div class='warning'>Database connection not available. Check settings/db_connect.php</div>";
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="stats">
        ...
        <div class="stat-grid">
            ...
            <div class="stat-item" style="background: #C09090;">
