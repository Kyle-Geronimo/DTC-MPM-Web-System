...
safe_execute(function () use ($conn, $v) {
    ...
    if ($stmt->execute()) {
        ...
        // Save a brief report record for real-time Reports page
        try {
            require_once(__DIR__ . '/report_helper.php');
            save_report($conn, 'Project Created: ' . $name, 'project', [
            ...
            error_log('create_project: failed to save report: ' . $e->getMessage());
        }
