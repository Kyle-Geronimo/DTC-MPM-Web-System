...
function exportPdf($data, $columns, $filename) {
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .report-header { text-align: center; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 3px solid #ef4444; }
        .report-header h1 { color: #b91c1c; font-size: 22px; margin-bottom: 4px; }
        .report-header .meta { color: #6b7280; font-size: 12px; }
        .print-btn { display: inline-block; background: #ef4444; color: white; border: none; padding: 10px 24px; border-radius: 6px; cursor: pointer; font-size: 14px; margin-bottom: 20px; }
        .print-btn:hover { background: #b91c1c; }
        table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        th { background: #b91c1c; color: white; padding: 8px 10px; text-align: left; font-weight: 600; font-size: 11px; }
