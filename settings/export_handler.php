...
function exportPdf($data, $columns, $filename) {
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .report-header { text-align: center; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 3px solid #2563eb; }
        .report-header h1 { color: #1e40af; font-size: 22px; margin-bottom: 4px; }
        .report-header .meta { color: #6b7280; font-size: 12px; }
        .print-btn { display: inline-block; background: #2563eb; color: white; border: none; padding: 10px 24px; border-radius: 6px; cursor: pointer; font-size: 14px; margin-bottom: 20px; }
        .print-btn:hover { background: #1d4ed8; }
        table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        th { background: #1e40af; color: white; padding: 8px 10px; text-align: left; font-weight: 600; font-size: 11px; }
