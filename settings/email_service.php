    ...
    private function wrapTemplate($content) {
        ...
        <head>
            <style>
                ...
                .email-header { background: linear-gradient(135deg, #ef4444 0%, #b91c1c 100%); color: white; padding: 24px; text-align: center; border-radius: 8px 8px 0 0; }
                ...
                .btn { display: inline-block; background: #ef4444; color: white; padding: 12px 28px; text-decoration: none; border-radius: 6px; margin: 16px 0; font-weight: 600; }
                .info-box { background: #fff5f5; border: 1px solid #ffd4d4; border-radius: 6px; padding: 16px; margin: 16px 0; }
            </style>
        </head>
        <body>
