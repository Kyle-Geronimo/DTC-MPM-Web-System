...
if (!isset($conn) || !($conn instanceof mysqli)) {
    $response = array('success' => false, 'message' => 'Database connection unavailable. Please check configuration.');
    ...
    if ($insertStmt->execute()) {
        ...
        <head>
            <style>
                ...
                .header { background: linear-gradient(135deg, #800000 0%, #660000 100%); color: white; padding: 20px; text-align: center; border-radius: 8px 8px 0 0; }
                .content { background: #E0CCCC; padding: 30px; border: 1px solid #D4A0A0; }
                .button { display: inline-block; background: #800000; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; margin: 20px 0; }
