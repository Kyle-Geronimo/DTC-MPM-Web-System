...
safe_execute(function() use ($conn) {
    ...
    $task_id = 'MEET-' . date('YmdHis') . '-' . substr(md5(random_bytes(16)), 0, 6);
    $created_at = date('Y-m-d H:i:s');

    // Insert meeting as task
    ...
    $stmt->bind_param("ssssssss", $task_id, $title, $full_description, $priority, $meeting_timestamp, $duration, $created_by, $created_at);
