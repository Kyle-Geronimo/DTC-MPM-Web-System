        ...
        try {
            ...
            modal.innerHTML = `
                <div style="background:#fff;border-radius:12px;padding:20px;max-width:520px;width:92%;box-shadow:0 8px 32px rgba(0,0,0,.25);">
                    <h3 style="margin-top:0">Edit Username</h3>
                    <form id="editUserForm">
                        ...
                        <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:12px">
                            ...
                            <button type="submit" id="saveEditUser" style="padding:8px 14px;border-radius:8px;border:none;background:#3b82f6;color:#fff;">Save</button>
                        </div>
                    </form>
                </div>`;
...
function deleteProject(projectId, name) {
    ...
    modal.innerHTML = `
        <div style="background:#fff;border-radius:12px;padding:28px;max-width:480px;width:92%;box-shadow:0 8px 32px rgba(0,0,0,.25);text-align:center;">
            ...
            <p style="color:#64748b;margin:0 0 20px;font-size:14px;">Are you sure you want to delete<br><strong>${escapeHtml(name)}</strong>?<br><span style="color:#ef4444;font-size:12px;">This action is permanent and cannot be undone.</span></p>
            <div style="display:flex;gap:12px;justify-content:center;">
