    ...
    messageButtons.forEach(button => {
        button.addEventListener('click', async function() {
            ...
            try {
                ...
                let response = await fetch('../settings/get_team_group_chat.php?team_id=' + encodeURIComponent(teamId));
                ...
                if (!response.ok && response.status === 404) {
                    try {
                        ...
                        if (createResp.ok) {
                            ...
                            response = await fetch('../settings/get_team_group_chat.php?team_id=' + encodeURIComponent(teamId));
                        } else {
