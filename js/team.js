    ...
    messageButtons.forEach(button => {
        button.addEventListener('click', async function() {
            ...
            try {
                ...
                const response = await fetch('../settings/get_team_group_chat.php?team_id=' + encodeURIComponent(teamId));
                ...
                if (data.success) {
                    ...
                    LoadingState.success(this, 'Opening...');
                    ...
                    if (window.chatSystem && typeof window.chatSystem.selectGroup === 'function') {
                        ...
                        Toast.error('Chat system not initialized. Please refresh the page.');
