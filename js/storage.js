...
uploadForm.addEventListener('submit', async e => {
    ...
    const folder_id   = (uploadForm.querySelector('#uploadFolder') && uploadForm.querySelector('#uploadFolder').value) || '';
    // Require a folder selection
    if (!folder_id) {
        showToast('Please select a destination folder. Uploads to root are not allowed.', 'error');
        return;
    }
