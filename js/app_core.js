...
// Make available globally & as toastr alias
window.Toast = Toast;
window.toastr = { success: (m) => Toast.success(m), error: (m) => Toast.error(m), warning: (m) => Toast.warning(m), info: (m) => Toast.info(m) };
