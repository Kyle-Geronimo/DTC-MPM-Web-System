...
├── front_panel.html                  # Front panel - dashboard and monitoring hub
...
#### 3. **Monitoring** (Merged into front_panel.html)
...
- **Access:** page/front_panel.html#monitoringOverview
- **CSS:** css/front-panel.css
...
#### 3. **Monitoring Styles** (Merged into css/front-panel.css)
- Health status cards
- Circular progress indicators
- Response chart styling
